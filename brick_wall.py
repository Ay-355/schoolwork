...
# only works if brick_width is double brick_height
    ...
    for y in range(cols):
        for x in range(rows):
            if x % 2 ==0:
                ...
                if y % 2 == 0:
                    draw_rect(x * (brick_width + mortar_width), y * (brick_height + mortar_width), brick_height - mortar_width/2, brick_width + mortar_width)
                    draw_rect(x * (brick_width + mortar_width) + (brick_width + mortar_width)/2, y * (brick_height + mortar_width), brick_height - mortar_width/2, brick_width + mortar_width)
...
draw_brick_wall_offset(8, 8, 50, 25, 5)
# draw_brick_wall_special(8, 8, 50, 25, 5)
turtle.done()
